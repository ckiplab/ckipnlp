...
.. |from_text| replace:: :meth:`from_text()`
.. |to_text| replace:: :meth:`to_text()`
.. |from_dict| replace:: :meth:`from_dict()`
.. |to_dict| replace:: :meth:`to_dict()`
.. |from_list| replace:: :meth:`from_list()`
.. |to_list| replace:: :meth:`to_list()`
